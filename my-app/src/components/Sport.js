...
class Newssport extends Component {
    ...
    async componentDidMount() {
        let url = "https://newsapi.org/v2/top-headlines?country=in&category=sports&apiKey=1a607034099d4ead9b99e6b3eb9e37a2&page=1&pagesize=12";
    ...
    handPre = async () => {
        let url = `https://newsapi.org/v2/top-headlines?country=in&category=sports&apiKey=1a607034099d4ead9b99e6b3eb9e37a2&page=${this.state.page - 1}&pagesize=12`;
        this.setState({
            loading: true
        })
        let data = await fetch(url);
