...
class Newstech extends Component {
    ...
    async componentDidMount() {
        let url = "https://newsapi.org/v2/top-headlines?country=us&category=technology&apiKey=f7401e037be644bcb3f5a3da071131e2&page=1&pagesize=12";
    ...
    handPre = async () => {
        let url = `https://newsapi.org/v2/top-headlines?country=us&category=technology&apiKey=f7401e037be644bcb3f5a3da071131e2&page=${this.state.page - 1}&pagesize=12`;
        this.setState({
            loading:true
        })
        let data = await fetch(url);
             ...
             {this.state.loading && <Spinner />}
                ...
                {!this.state.loading && this.state.articles.map((element, index) => {
                        ...
                        <div className="col" key={element.url}>
                            <div className="card">
                                {/* Card content */}
                                <img src={element.urlToImage ? element.urlToImage : "https://i.gadgets360cdn.com/large/nothing_phone_2_first_look_cover_gadgets360_1689077818456.jpg"} className="card-img-top" alt="..." />
