...
class Newsenter extends Component {
    ...
    async componentDidMount() {
        let url = "https://newsapi.org/v2/top-headlines?country=us&category=entertainment&apiKey=f7401e037be644bcb3f5a3da071131e2&page=1&pagesize=12";
         let Parsedata;
        try {
    ...
    handPre = async () => {
        let url = `https://newsapi.org/v2/top-headlines?country=us&category=entertainment&apiKey=f7401e037be644bcb3f5a3da071131e2&page=${this.state.page - 1}&pagesize=12`;
        this.setState({
            loading:true
        })
        let data = await fetch(url);
              ...
              {this.state.loading && <Spinner/>}
                ...
                {!this.state.loading && this.state.articles.map((element, index) => {
                        ...
                        return (
                            ...
                            <div className="card">
                                <img src={element.urlToImage ? element.urlToImage : "https://express-images.franklymedia.com/7027/sites/8/2017/01/27124604/EntertainmentNews_Logo_500x281.jpg"} className="card-img-top" alt="..." />
