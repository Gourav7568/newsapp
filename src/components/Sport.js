...
class Newssport extends Component {
    ...
    async componentDidMount() {
        let url = "https://newsapi.org/v2/top-headlines?country=us&category=sports&apiKey=f7401e037be644bcb3f5a3da071131e2&page=1&pagesize=12";
    ...
    handPre = async () => {
        let url = `https://newsapi.org/v2/top-headlines?country=us&category=sports&apiKey=f7401e037be644bcb3f5a3da071131e2&page=${this.state.page - 1}&pagesize=12`;
        this.setState({
            loading: true
        })
        let data = await fetch(url);
            ...
            <>
                ...
                {!this.state.loading && this.state.articles.map((element, index) => {
                        ...
                        return (
                            ...
                            <div className="card">
                                <img src={element.urlToImage ? element.urlToImage : "https://tse1.mm.bing.net/th?id=OIP.dQJXy0gXF6E6j6dJON3F9gHaEi&pid=Api&rs=1&c=1&qlt=95&h=180"} className="card-img-top" alt="..." />
